...
C_SRCS += \
C:/NXP/MKW41Z_ConnSw_1.0.2/devices/MKW41Z4/system_MKW41Z4.c 

S_UPPER_SRCS += \
C:/NXP/MKW41Z_ConnSw_1.0.2/devices/MKW41Z4/gcc/startup_MKW41Z4.S 

OBJS += \
./ksdk/devices/MKW41Z4/startup_MKW41Z4.o \
./ksdk/devices/MKW41Z4/system_MKW41Z4.o 

C_DEPS += \
./ksdk/devices/MKW41Z4/system_MKW41Z4.d 

S_UPPER_DEPS += \
./ksdk/devices/MKW41Z4/startup_MKW41Z4.d 


# Each subdirectory must supply rules for building sources it contributes
ksdk/devices/MKW41Z4/startup_MKW41Z4.o: C:/NXP/MKW41Z_ConnSw_1.0.2/devices/MKW41Z4/gcc/startup_MKW41Z4.S
	@echo 'Building file: $<'
	@echo 'Invoking: Cross ARM GNU Assembler'
	arm-none-eabi-gcc -mcpu=cortex-m0plus -mthumb -Og -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -fno-common -ffreestanding -fno-builtin -Wall -Wno-unused-function -Wno-missing-braces -Wno-pointer-sign  -g -x assembler-with-cpp -DDEBUG -I../../../../../../../../middleware/wireless/framework_5.3.2/common/rtos/freertos/config -I../../../../../../../../middleware/wireless/framework_5.3.2/common/rtos/freertos/config -fno-common  -ffunction-sections  -fdata-sections  -ffreestanding  -fno-builtin  -Os  -mapcs  -std=c99 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '

ksdk/devices/MKW41Z4/system_MKW41Z4.o: C:/NXP/MKW41Z_ConnSw_1.0.2/devices/MKW41Z4/system_MKW41Z4.c
	@echo 'Building file: $<'
